    ...
    async function runAudio2(arg2, sound) {  
     ...
     setIsPlaying(!isPlaying)
        ...
        var handleClick = (title, illustration, sound, pos) =>{
            ...
            // var encoreColorInt = [...colorInt]            
            // for(var i=0; i<encoreColorInt.length; i++){
            //     console.log('avant' + encoreColorInt)
            //     encoreColorInt[pos] = true
            //     console.log('je suis dans la boucle' + encoreColorInt[pos])
            // }
            // setColorInt(encoreColorInt)
            // if(colorInt[pos] == false){
            //     iconColor='#a2a1e5'
            // } else {
            //     iconColor= '#4D3D84'
            // }
